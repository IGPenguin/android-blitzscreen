...
public class AdbCommandDispatcher {

    private static boolean recordingAvailable() {
    ...
    private static void takeScreenshot(int deviceIndex, String fileName) {
    ...
    private static void stopRecordingScreen(int deviceIndex, String fileName) {
    ...
    private static void stopRecordingScreen(int deviceIndex) {
        String fileName = Calendar.getInstance().getTime().toString().replaceAll("\\s", "-").replaceAll(":", "-");
    ...
    public static void takeScreenshotOfDefaultDevice() {
    ...
    public static void takeScreenshotOfAllDevices() {
        DataManager.updateAdbDeviceList();
    ...
    public static void recordDefaultDevice() {
        DataManager.updateAdbDeviceList();
        if (DataManager.getDefaultAdbDeviceIndex() != (-1)) {
    ...
    public static void cycleDefaultDevice() {
